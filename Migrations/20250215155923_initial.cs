    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MucDos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorIcon = table.Column<string>(type: "TEXT", nullable: true),
                    QuizzId = table.Column<int>(type: "INTEGER", nullable: true),
                    QuestionText = table.Column<string>(type: "TEXT", nullable: true),
                    Question_Image = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entities_Entities_DanhMucId",
                        column: x => x.DanhMucId,
                        principalTable: "Entities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entities_Entities_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Entities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entities_Entities_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Entities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entities_Entities_QuizzId",
                        column: x => x.QuizzId,
                        principalTable: "Entities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entities_MucDos_MucDoId",
                        column: x => x.MucDoId,
                        principalTable: "MucDos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entities_DanhMucId",
                table: "Entities",
                column: "DanhMucId");

            migrationBuilder.CreateIndex(
                name: "IX_Entities_MucDoId",
                table: "Entities",
                column: "MucDoId");

            migrationBuilder.CreateIndex(
                name: "IX_Entities_QuestionId",
                table: "Entities",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_Entities_QuizId",
                table: "Entities",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_Entities_QuizzId",
                table: "Entities",
                column: "QuizzId");
